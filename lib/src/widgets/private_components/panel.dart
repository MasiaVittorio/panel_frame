...
class _Panel extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final collapsedMargins =
        EdgeInsets.symmetric(horizontal: style.collapsedPanelHorizontalMargin) +
        viewPadding +
        EdgeInsets.only(bottom: bottomBarHeight);

    // computed once instead of inside the value builder
    final cc = style.collapsedPanelBackgroundColor;
    final ec = style.expandedPanelBackgroundColor;

    final cr = style.collapsedPanelBorderRadius;
    final er = style.expandedPanelBorderRadius;

    final cb = style.collapsedPanelBorderSide;
    final eb = style.expandedPanelBorderSide;
